# Requirements Archive: v1.0 Buy Signal MVP

**Archived:** 2026-03-22
**Status:** SHIPPED

The live `.planning/REQUIREMENTS.md` was intentionally cleared at milestone completion. Use `$gsd-new-milestone` to create the next milestone's fresh requirements file.
